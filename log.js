...
const kprod = require('./kafka-producer.js');
...
exports.fatal = (_msg) => {
    ...
    kprod.send("global_errors", JSON.stringify(msg));
};
...
exports.warn = (_msg) => {
    ...
    kprod.send("global_info", JSON.stringify(msg));
};
...
exports.debug = (_msg) => {
    if (logLevel === 'debug' || logLevel === 'trace') {
        ...
        kprod.send("global_debug", JSON.stringify(msg));
    }
};
...
exports.trace = (_msg) => {
    if (logLevel === 'trace') {
        ...
        kprod.send("global_debugs", JSON.stringify(msg));
    }
};